    ...
    <div className=' w-full text-xs text-center '>
      ...
      <div className=''>
        ...
        <div className='flex flex-row justify-around p-2 border'>
          ...
          <div>
            <button className='border m-1 mt-7 p-2 border-b-4 hover:bg-cyan-300/80 hover:border-slate-400 hover:text-black' onClick={addRiskToBackend}>Adicionar Risco</button>
          </div>
        </div>  
      ...
      <div className='m-2'>
        ...
        <div>
        {/* Pagination controls */}
        <button className='mr-2 mt-2 border-b-4 border p-2 hover:bg-white hover:border-black/80 hover:text-black hover:text-sm' disabled={currentPage === 1} onClick={() => handlePageChange(currentPage - 1)}>
          Anterior
        </button>
        <button className='border border-b-4 mt-2 p-2 hover:bg-white hover:border-black/80 hover:text-black hover:text-sm' onClick={() => handlePageChange(currentPage + 1)}>
          Proximo
        </button>
      </div>
      </div>

  ...
  return (
    ...
    <div className=' w-full text-xs text-center '>
      ...
      <div className='m-2'>
        ...
        <div>
        {/* Pagination controls */}
        <button className='mr-2 mt-2 border-b-4 border p-2 hover:bg-cyan-300/80 hover:border-slate-400 hover:text-black' disabled={currentPage === 1} onClick={() => handlePageChange(currentPage - 1)}>
          Anterior
        </button>
        <button className='border border-b-4 mt-2 p-2 hover:bg-cyan-300/80 hover:border-slate-400 hover:text-black' onClick={() => handlePageChange(currentPage + 1)}>
          Proximo
        </button>
      </div>
      </div>

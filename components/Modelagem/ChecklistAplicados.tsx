    ...
    <div className='flex justify-between ml-2 w-full'>
      <div className="applied-checklists-page border p-5 w-1/3">
        ...
        <ul className="applied-checklist-list border bg-black">
          {RiskItems.map((risk) => (
            <li key={risk.id} className="applied-checklist-item bg-slate/10">
          ...
          {selectedRiskValue !== null && (
            <div>
              <p className='p-2 bg-slate/30 text-white'>Risco selecionado: {selectedRiskValue} | codigo: {selectedRiskId}</p>
              <button 
           ...
           {Object.entries(groupedQuestions).map(([subject, subjectQuestions]) => (
            <div key={subject}>
              ...
              {subjectQuestions.map((question) => (
                <div key={question.id}>
                  <div className="flex flex-row justify-between bg-slate/30">

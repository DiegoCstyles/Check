...
var AppliedChecklistsPage = function () {
    var _a = useState([]), appliedChecklists = _a[0], setAppliedChecklists = _a[1];
    var fetchAppliedChecklists = function () { return __awaiter(void 0, void 0, void 0, function () {
        var response, data, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    return [4 /*yield*/, fetch('http://localhost:5000/api/appliedChecklists')];
                case 1:
                    response = _a.sent();
    ...
    <div className="applied-checklists-page border ml-2 p-5">
      ...
      <ul className="applied-checklist-list">
        {appliedChecklists.map(function (checklist) { return (<li key={checklist.id} className="applied-checklist-item">

...
var AppliedChecklistsChart = function () {
    var chartData = {
    ...
    <div className='m-2 text-xs text-center'>
      ...
      <div className="mx-48 chart-container">
        <div className='flex ' style={{ width: chartWidth, height: chartHeight }}>
          <Bar className='m-5 ' data={chartData} options={{
            indexAxis: 'y',
            responsive: true,
            color: 'white',
            scales: {
          ...
          <Bar className='m-5' data={chartDataUserRanking} options={{
            indexAxis: 'x',
            responsive: true,
            color: 'white',
            scales: {
        ...
        <div className='flex' style={{ width: chartWidth, height: chartHeight }}>
            <Bar className='m-5' data={chartDataBestScore} options={{
            indexAxis: 'x',
            responsive: true,
            color: 'white',
            scales: {
          ...
          <Bar className='m-5' data={chartDataWorstScore} options={{
            indexAxis: 'x',
            responsive: true,
            color: 'white',
            scales: {
